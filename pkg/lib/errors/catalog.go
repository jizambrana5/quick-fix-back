...
var (
	...
	InvalidUserCredentials         = AppError{Err: fmt.Errorf("invalid user credentials"), httpCode: http.StatusBadRequest, internalCode: "invalid user credentials"}
	InvalidProfessionalCredentials = AppError{Err: fmt.Errorf("invalid professional credentials"), httpCode: http.StatusBadRequest, internalCode: "invalid professional credentials"}
)
